...
public:
    // Access result
    double result() { return myResult; }

    // Access adjoint
    double& adjoint() { return myAdjoint; }
...
public:
    Leaf(double val) { myResult = val; }

    double getVal() { return myResult; }

    void setVal(double val) { myResult = val; }
